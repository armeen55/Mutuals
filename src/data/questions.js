...
//
// Each question:
//   id, pack, lean, slot, heat, audience, shareable, prompt, about, options
//   (namepick questions also carry enabled:false and are excluded from play)
//
// pack: default | chaos | afterdark | namepick
// lean: duo | group | both
// slot: warmup | roast | receipt | ego | status | flirt | money | party | tension | sincere | namepick
// heat: 1 safe · 2 playful · 3 real · 4 spicy · 5 nuclear-but-playable
// audience: all | adult        shareable: boolean

export const ALL_QUESTIONS = [
  // ============================ LANE A — all audiences ============================
  { id: "q1", pack: "default", lean: "both", slot: "receipt", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q2", pack: "default", lean: "both", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q3", pack: "default", lean: "both", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q4", pack: "default", lean: "both", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q5", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q6", pack: "default", lean: "both", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q7", pack: "default", lean: "both", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q8", pack: "default", lean: "group", slot: "receipt", heat: 2, audience: "all", shareable: true,
  ...
  { id: "q9", pack: "default", lean: "group", slot: "receipt", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q10", pack: "default", lean: "group", slot: "receipt", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q11", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q12", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q13", pack: "default", lean: "group", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q14", pack: "default", lean: "group", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q15", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q16", pack: "default", lean: "group", slot: "roast", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q17", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q18", pack: "default", lean: "both", slot: "sincere", heat: 3, audience: "all", shareable: false,
  ...
  { id: "q19", pack: "default", lean: "both", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q20", pack: "chaos", lean: "group", slot: "chaos", heat: 5, audience: "all", shareable: true,
  ...
  { id: "q21", pack: "default", lean: "group", slot: "ego", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q22", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q23", pack: "default", lean: "both", slot: "sincere", heat: 3, audience: "all", shareable: false,
  ...
  { id: "q24", pack: "default", lean: "group", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q25", pack: "default", lean: "duo", slot: "flirt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q26", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q27", pack: "default", lean: "group", slot: "status", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q28", pack: "default", lean: "group", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q29", pack: "default", lean: "both", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q30", pack: "default", lean: "group", slot: "money", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q31", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q32", pack: "default", lean: "group", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q33", pack: "default", lean: "group", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q34", pack: "default", lean: "both", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q35", pack: "default", lean: "group", slot: "status", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q36", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q37", pack: "default", lean: "group", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q38", pack: "default", lean: "both", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q39", pack: "default", lean: "group", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q40", pack: "default", lean: "duo", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q41", pack: "default", lean: "both", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q42", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q43", pack: "default", lean: "both", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q44", pack: "default", lean: "group", slot: "status", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q45", pack: "default", lean: "duo", slot: "sincere", heat: 3, audience: "all", shareable: false,
  ...
  { id: "q46", pack: "default", lean: "duo", slot: "sincere", heat: 3, audience: "all", shareable: false,
  ...
  { id: "q47", pack: "default", lean: "both", slot: "warmup", heat: 2, audience: "all", shareable: true,
  ...
  { id: "q48", pack: "default", lean: "both", slot: "warmup", heat: 2, audience: "all", shareable: true,
  ...
  { id: "q49", pack: "default", lean: "group", slot: "roast", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q50", pack: "default", lean: "both", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q51", pack: "default", lean: "group", slot: "receipt", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q52", pack: "default", lean: "both", slot: "warmup", heat: 2, audience: "all", shareable: true,
  ...
  { id: "q53", pack: "default", lean: "group", slot: "ego", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q54", pack: "default", lean: "duo", slot: "flirt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q55", pack: "default", lean: "group", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q56", pack: "default", lean: "both", slot: "warmup", heat: 1, audience: "all", shareable: false,
  ...
  { id: "q57", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q58", pack: "default", lean: "group", slot: "status", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q59", pack: "default", lean: "both", slot: "roast", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q60", pack: "default", lean: "both", slot: "tension", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q61", pack: "default", lean: "group", slot: "receipt", heat: 4, audience: "all", shareable: true,
  ...
  { id: "q62", pack: "default", lean: "both", slot: "ego", heat: 3, audience: "all", shareable: true,
  ...
  { id: "q63", pack: "default", lean: "duo", slot: "sincere", heat: 3, audience: "all", shareable: false,
  ...
  { id: "q64", pack: "chaos", lean: "group", slot: "chaos", heat: 5, audience: "all", shareable: true,
  ...
  // ============================ LANE B — adult / after dark (18+) ============================
  { id: "q65", pack: "afterdark", lean: "both", slot: "party", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q66", pack: "afterdark", lean: "group", slot: "money", heat: 3, audience: "adult", shareable: true,
  ...
  { id: "q67", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q68", pack: "afterdark", lean: "both", slot: "flirt", heat: 5, audience: "adult", shareable: true,
  ...
  { id: "q69", pack: "afterdark", lean: "both", slot: "party", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q70", pack: "afterdark", lean: "duo", slot: "flirt", heat: 5, audience: "adult", shareable: true,
  ...
  { id: "q71", pack: "afterdark", lean: "group", slot: "money", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q72", pack: "afterdark", lean: "group", slot: "status", heat: 5, audience: "adult", shareable: true,
  ...
  { id: "q73", pack: "afterdark", lean: "duo", slot: "flirt", heat: 5, audience: "adult", shareable: true,
  ...
  { id: "q74", pack: "afterdark", lean: "group", slot: "chaos", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q75", pack: "afterdark", lean: "both", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q76", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q77", pack: "afterdark", lean: "both", slot: "party", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q78", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q79", pack: "afterdark", lean: "group", slot: "money", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q80", pack: "afterdark", lean: "both", slot: "party", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q81", pack: "afterdark", lean: "group", slot: "status", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q82", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q83", pack: "afterdark", lean: "both", slot: "tension", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q84", pack: "afterdark", lean: "group", slot: "party", heat: 3, audience: "adult", shareable: true,
  ...
  { id: "q85", pack: "afterdark", lean: "both", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q86", pack: "afterdark", lean: "group", slot: "roast", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q87", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q88", pack: "afterdark", lean: "both", slot: "tension", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q89", pack: "afterdark", lean: "group", slot: "money", heat: 3, audience: "adult", shareable: true,
  ...
  { id: "q90", pack: "afterdark", lean: "duo", slot: "flirt", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q91", pack: "afterdark", lean: "both", slot: "party", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q92", pack: "afterdark", lean: "group", slot: "status", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q93", pack: "afterdark", lean: "both", slot: "tension", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q94", pack: "afterdark", lean: "duo", slot: "flirt", heat: 5, audience: "adult", shareable: true,
  ...
  { id: "q95", pack: "afterdark", lean: "group", slot: "roast", heat: 4, audience: "adult", shareable: true,
  ...
  { id: "q96", pack: "afterdark", lean: "both", slot: "sincere", heat: 3, audience: "adult", shareable: false,
  ...
  // ============================ name-pick (metadata only — disabled in play) ============================
  { id: "n1", pack: "namepick", lean: "group", slot: "namepick", heat: 3, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n2", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
    prompt: "The person here who knows too much about me is…", about: "The person who knows too much about {name} is…", options: [] },
  { id: "n3", pack: "namepick", lean: "group", slot: "namepick", heat: 5, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n4", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n5", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n6", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n7", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
    prompt: "The person here who would sell me out funniest is…", about: "The person who would sell {name} out funniest is…", options: [] },
  { id: "n8", pack: "namepick", lean: "group", slot: "namepick", heat: 3, audience: "all", shareable: true, enabled: false,
    prompt: "The person here who reads me too well is…", about: "The person who reads {name} too well is…", options: [] },
  { id: "n9", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n10", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n11", pack: "namepick", lean: "group", slot: "namepick", heat: 3, audience: "all", shareable: true, enabled: false,
    prompt: "The person here who'd survive a week as me is…", about: "The person who'd survive a week as {name} is…", options: [] },
  { id: "n12", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "all", shareable: true, enabled: false,
  ...
  { id: "n13", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "adult", shareable: true, enabled: false,
  ...
  { id: "n14", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "adult", shareable: true, enabled: false,
    prompt: "The person here I'd trust to plan the chaos is…", about: "The person {name} would trust to plan the chaos is…", options: [] },
  { id: "n15", pack: "namepick", lean: "group", slot: "namepick", heat: 4, audience: "adult", shareable: true, enabled: false,
    prompt: "The person here most likely to fall first is…", about: "The person most likely to fall first, per {name}, is…", options: [] },
  { id: "n16", pack: "namepick", lean: "group", slot: "namepick", heat: 3, audience: "adult", shareable: true, enabled: false,
...
export function selectQuestions(groupId, mode, count, opts = {}) {
  const n = count || roomQuestionCount(groupId);
  const adult = !!opts.adult;
  const rng = mulberry32(hashStr(String(groupId || "default")));
  const pool = shuffled(
    ALL_QUESTIONS.filter((q) => q.enabled !== false && q.pack !== "namepick" && (adult || q.audience !== "adult")),
    rng
  );
...
export function validateQuestionBank() {
  ...
  for (const q of ALL_QUESTIONS) {
    for (const f of ["id", "pack", "lean", "slot", "audience", "prompt", "about"]) {
  ...
  return {
    ...
    byAudience: tally(playable, "audience"),
    ...
    softCombined,
    namepick: ALL_QUESTIONS.filter((q) => q.pack === "namepick").length,
    issues,
  };
}
